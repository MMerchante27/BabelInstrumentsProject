angular.module("babelInstruments").controller("BassDetailController", ["$window","$scope", "$routeParams", "$location", "$sce", "URL", "APIClient", "paths", "authService", "buyService", "logService",
