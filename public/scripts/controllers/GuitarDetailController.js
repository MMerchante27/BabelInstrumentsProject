angular.module("babelInstruments").controller("GuitarDetailController", ["$window","$scope", "$routeParams", "$location", "$sce", "APIClient", "authService", "paths", "buyService",
    function($window,$scope, $routeParams, $location, $sce, APIClient, authService, paths, buyService) {
